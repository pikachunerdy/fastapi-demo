from app.api.models.account_models import AccountInfo, Account, RegisterAccount, ModifyAccount
...
class AccountHandler:
    ...
    @staticmethod
    async def create_account(new_account : RegisterAccount, company_id : int) -> Account:
    ...
    async def modify(self, account : ModifyAccount) -> AccountInfo:
        ...
        self._sql_account.permissions = permissions_to_sqlpermissions(account.permissions)
